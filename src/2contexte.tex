\section{Présentation du contexte du projet}
    \subsection{\company{}}
        ...
        Ces équipes travaillent sur différents projets autour des produits hardwares et softwares comme le montre le tableau \ref{table:1} de la page \pageref{table:1}
            \begin{table}[h!]
                \centering
